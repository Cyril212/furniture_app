...
import 'package:furniture_app/pages/furniture_sub_category/furniture_sub_category.dart';
...
var routes = <String, WidgetBuilder>{
  ...
  "/furniture_sub_category": (BuildContext context) => FurnitureSubCategoryScreen()
};
